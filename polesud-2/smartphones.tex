...
\begin{frame}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./scared-hitty-500x375.jpg} 
\end{frame}
}
...
\begin{frame}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./WarKitten.jpg} 
\end{frame}
}
...
\item \textbf{\href{http://davdroid.bitfire.at/what-is-davdroid}{DAVDroid}} (opensource, demande un hébergement spécialisé; compatible OwnCloud, Baïkal, etc)
...
\item \textbf{\href{https://www.protonmail.ch}{ProtonMail}} (Suisse; gratuit, mais liste d'attente)
\item \textbf{\href{https://ethack.org/}{EthACK}} (Suisse; oui, on planche dessus (depuis 2014…))
\end{itemize}
\end{frame}
...
\begin{frame}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./Kitten_Computer_Repair.jpg} 
\end{frame}
}
